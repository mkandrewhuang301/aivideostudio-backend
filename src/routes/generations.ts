...
generationsRouter.post('/', promptModerationMiddleware, presetResolver, formatResolver, prepareCost, celebrityCheckMiddleware, inputMediaGate, entitlementGate, concurrencyGate, creditCheckMiddleware, async (req: Request, res: Response) => {
